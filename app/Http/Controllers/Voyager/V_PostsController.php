...
class V_PostsController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        // podaci o POSTu
        $postDATA = DB::table('posts as POS')
                            ->join('users as USR','USR.id','POS.author_id')
                            ->leftJoin('categories as CAT','CAT.id','POS.category_id')
                            ->where('POS.id',$id)
                            ->select(
                                'POS.id as pos_id',
                                ...
                                'POS.seo_title as pos_seo_title',
                                'POS.excerpt as pos_excerpt',
                                'POS.body as pos_body',
                                'POS.image as pos_image',
                                'POS.slug as pos_slug',
                                'POS.meta_description as pos_meta_description',
                                'POS.meta_keywords as pos_meta_keywords',
                                'POS.status as pos_status',
                                'POS.featured as pos_featured',
                                'POS.created_at as pos_created_at',
                                'POS.updated_at as pos_updated_at',
    ...
    public function edit(Request $request, $id)
    {
        ...
        // kategorije za POSTove
        $postsCategories_SEL = Category::postsCategories_SEL();
