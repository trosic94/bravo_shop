...
use App\Banner;
use App\BannersClient;
use App\BannersPosition;
use App\BannersTrackImpression;

class V_BannerController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        // BANNER data
        $bannerDATA = Banner::bannerDATAfull($id);
    ...
    public function edit(Request $request, $id)
    {
        ...
        // Banner DATA
        $bannerDATA = Banner::bannerDATA($id);

        // Banners Clents
        $bannersClients = BannersClient::allBannersClients();

        // Banners Positions
        $bannersPositions = BannersPosition::allBannersPositions();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable',
                                                'url','bannerDATA','bannersClients','bannersPositions'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable',
                                                'url','bannersClients','bannersPositions'));
    }
