...
class V_OrderController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        // svi podaci o ORDERu
        $orderDATA = Order::orderDATA($id);

        // svi podaci o stavkama
        $orderItemsDATA = OrderItems::orderItemsDATA($id);
    ...
    public function edit(Request $request, $id)
    {
        ...
        // STATUSi za ORDER
        $orderSTatusALL = OrderStatus::orderStatusALL();

        // PAYMENT opcije
        $paymentMethodALL = PaymentMethod::paymentMethods();

        // svi podaci o ORDERu
        $orderDATA = Order::orderDATA($id);

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable',
                                                'orderSTatusALL','paymentMethodALL','orderDATA'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $updateOrder = Order::where('id',$id)->update([
