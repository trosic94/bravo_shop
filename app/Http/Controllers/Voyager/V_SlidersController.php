...
class V_SlidersController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        // podaci o SLIDERu
        $sliderDATA = Sliders::where('id',$id)->first();

        // podaci o SLAJDOVIMA
        $sliderITEMs = SlidersItems::where('slider_id',$id)->orderBy('slide_order','ASC')->get();
