...
class AttributesCategory extends Model
{
	...
	public static function attributesDATA_for_All()
    {
        ...
        foreach ($attributesDATA_tmp as $ATTkey => $attribute) {
			...
			$attributesDATA_for_All[$ATTkey]['attr_id'] = $attribute->attr_id;
			$attributesDATA_for_All[$ATTkey]['attr_name'] = $attribute->attr_name;
			$attributesDATA_for_All[$ATTkey]['attr_description'] = $attribute->attr_description;
			$attributesDATA_for_All[$ATTkey]['attr_type'] = $choosenTYPE;
			$attributesDATA_for_All[$ATTkey]['attr_type_id'] = $attribute->attr_type;
			$attributesDATA_for_All[$ATTkey]['attr_unit'] = $attribute->attr_unit;
			$attributesDATA_for_All[$ATTkey]['attr_image'] = $attribute->attr_image;
			$attributesDATA_for_All[$ATTkey]['attr_status'] = $attribute->attr_status;
			...
			foreach ($attributeValues_TMP as $VALkey => $val) {
				...
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['id'] = $val->val_id;
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['label'] = $val->val_label;
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['value'] = $val->val_value;
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['order'] = $val->val_order;
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['status'] = $val->val_status;
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['price'] = $val->val_price;
				$attributesDATA_for_All[$ATTkey]['attr_values'][$VALkey]['image'] = $val->val_image;
				
			}

        }

        return $attributesDATA_for_All;
    }
