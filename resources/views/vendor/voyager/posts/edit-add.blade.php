...
{{--                                     @foreach(TCG\Voyager\Models\Category::all() as $category)
                                    ...
                                    @foreach ($postsCategories_SEL as $key => $category)
                                        <option value="{{ $category['cat_id'] }}" {{ ($dataTypeContent->category_id == $category['cat_id'])? 'selected':'' }}>{{ $category['cat_name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
